...
$sql_assigncar = "SELECT b.*,a.first_name, a.last_name
                  FROM booking AS b
                  INNER JOIN admin as a ON b.user_id=a.id
                  ORDER BY b.id ASC";

$result = $conn->query($sql_assigncar);
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card shadow" style="overflow-x:auto;">
                                  <div class="card-header border-0">
                                      <span class="float-start fs-5" style="line-height: 3.0rem"> <i class="fas fa-th-list"></i>&nbsp;&nbsp; รายการรออนุมัติ</span> <a href="checkdetail.php">เช็คข้อมูล</a>
                                  </div> 
                                  ...
                                  <div class="card-body" style="overflow-x:auto;">
                                      <div class="table-responsive">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td class="align-middle text-center">
                                                        ...
                                                        <?php if ($row['status'] == 'wait') { ?>
                                                                <p style="font-size:1.1rem;"><span class="badge rounded-pill bg-warning"><i class="fa fa-hourglass-start"></i> <?php echo 'รอจ่ายรถ' ?></span></p>
                                                            <?php } elseif ($row['status'] == 'true') { ?>
                                                                <p style="font-size:1.1rem;"><span class="badge rounded-pill bg-success"><i class="fa fa-check-circle"></i> <?php echo 'จ่ายรถแล้ว' ?></span></p>
                                                            <?php } else { ?>
                                                                <p style="font-size:1.1rem;"><span class="badge rounded-pill bg-danger"><i class="fas fa-times"></i> <?php echo 'ไม่อนุมัติ' ?></span></p>
                                                        <?php } ?>
                                                  
                                                  </td>
                                                
                                                      <td class="align-middle text-center">
                                                          <button type="button" class="btn btn-sm btn-info btn-action" data-bs-toggle="modal" data-bs-target="#modalvehicle<?php echo $row['id'] ?>">
                                                            <i class="fas fa-search"></i> เรียกดู
                                                          </button>
                                                                
                                                          <a href="form-approve.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success btn-action">
                                        ...
                                        ?>
                                        <section class="modal fade" id="modalvehicle<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
