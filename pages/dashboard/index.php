										...
										<div class="pull-left form-inline float-end">
											<div class="btn-group">
												<button class="btn btn-primary" data-calendar-nav="prev">
													<i class="fas fa-angle-double-left"></i> Prev</button>
												<button class="btn btn-danger" data-calendar-nav="today"><i class="fas fa-calendar-day"></i> Today</button>
												<button class="btn btn-primary" data-calendar-nav="next">Next <i class="fas fa-angle-double-right"></i></button>
											</div>
