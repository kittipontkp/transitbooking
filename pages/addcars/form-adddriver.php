...
<!-- Section content -->
        ...
        <div class="card mt-4">
                <div class="card-header">
                    <div class="btn-group-add float-start">
                    <a href="index.php" class="btn btn-sm float-start btn-backward"><i class="fas fa-angle-double-left"></i> 
                        ย้อนกลับ
                          ...
                          <span class="float-right" style="line-height: 2.5rem"> <i class="fas fa-clipboard-list"></i>  เพิ่มข้อมูลผู้ขับขี่ยานพาหนะ</span>
                </div>
          ...
          <div class="form-group">
              <label for="carregis">ชื่อ - นามสกุล <span style="color:red">*</span></label>
              <input type="text" class="form-control" name="car_regis" id="carregis" placeholder="ชื่อ - นามสกุล (ระบุคำนำหน้าชื่อด้วย)" required>
            </div>
          </div>
          <div class="col-md-6">
          <div class="form-group">
              <label for="carbrand">หมายเลขโทรศัพท์มือถือ <span style="color:red">*</span></label>
              <input type="text" class="form-control" name="car_brand" id="carbrand" placeholder="หมายเลขโทรศัพท์มือถือ" required>
            </div>
          </div>
          </div>
          ...
          <div class="col-md-6">
          <div class="form-group">
              <label for="cartype">หมายเลขโทรศัพท์ภายใน <span style="color:red">*</span></label>
              <input type="text" class="form-control" name="car_type" id="cartype" placeholder="หมายเลขโทรศัพท์ภายใน" required>
            </div>
          </div>
          <div class="col-md-6">
          <div class="form-group">
              <label>สถานะผู้ขับขี่ยานพาหนะ <span style="color:red">*</span></label>
              <select class="form-control" name="car_status" required>
              <option value="" disabled selected>กำหนดสถานะผู้ขับขี่ยานพาหนะ</option>
